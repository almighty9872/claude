...
window.CHURCHES = /*JSON-START*/{
 "title": "Kilise Bul",
 "en": "Find a Parish",
 "intro": "Türkiye’deki Latin, Ermeni, Süryani ve Keldani Katolik kiliseleri. Ayin saatleri değişebilir; gitmeden önce kiliseyle teyit edin.",
 "introEn": "Latin, Armenian, Syriac and Chaldean Catholic churches in Turkey. Mass times can change, so check with the parish before you go.",
 "touristNote": "Turistler için de: kiliselerin çoğunda İngilizce, İtalyanca, Fransızca ya da Latince bir ayin bulunur.",
 "touristNoteEn": "For visitors too: many parishes have a Mass in English, Italian, French or Latin.",
 ...
 "orthodoxNoteEn": "If there's no Catholic church near you, there may be an Orthodox one. Under canon law (Canon 844 §2), when a Catholic can't reach a Catholic priest and there is real need, they may receive the Eucharist, Confession and the Anointing of the Sick from the Orthodox Church, whose sacraments are valid. This is an exceptional permission, not an everyday practice; each community has its own discipline, and the priest may not always give Communion.",
 "rites": [
  {
   "id": "latin",
   "tr": "Latin Katolik",
