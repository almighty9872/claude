...
window.CHURCHES = /*JSON-START*/{
  "title": "Kilise Bul",
  "en": "Find a Parish",
  "intro": "Türkiye’de etkin Latin, Ermeni Katolik, Süryani Katolik ve Keldani Katolik kiliselerinin bir listesi; cemaatlerin kendi bilgilerinden derlenmiştir, ayin saatleri değişebilir.",
  "introEn": "A directory of active Latin, Armenian, Syriac and Chaldean Catholic parishes in Turkey, compiled from each community’s own information. Mass times can change, so confirm with the parish before visiting.",
  "touristNote": "Türkiye’yi ziyaret eden Katolik turistler de kullanabilir: kiliselerin çoğu ziyaretçileri ağırlar, birçoğunda İngilizce, İtalyanca, Fransızca ya da Latince bir ayin de bulunur.",
  "touristNoteEn": "Catholic tourists visiting Turkey can use it too: most parishes welcome visitors, and many hold at least one Mass in English, Italian, French or Latin.",
  ...
  "orthodoxNote": "Türkiye’nin bazı bölgelerinde yakın çevrede bir Katolik kilisesi bulunmayabilir, oysa bir Ortodoks kilisesi bulunabilir. Kilise Hukuku (1983 Kanunlar Kitabı, Kanun 844 §2) şunu öngörür: bir Katolik’in kendi Kilisesi’nin bir rahibine ulaşması fiilen ya da manen mümkün değilse, gerçek bir gereklilik ya da manevi yarar söz konusuysa ve hata ya da dinler arası kayıtsızlık tehlikesi yoksa; sırları Katolik Kilisesi tarafından geçerli kabul edilen (Ortodoks Kilisesi gibi) bir Doğu Kilisesi’nden Kutsal Efkaristiya’yı, Günah Çıkarma’yı ve Hastaların Meshi’ni almak caizdir. Bu, olağan bir uygulama değil, istisnai durumlar için tanınmış bir izindir; sırları geçerli kabul edilmeyen topluluklar için geçerli değildir. Kutsal Komünyon’u layıkıyla almaya hazır olan (yani ölümcül bir günahın bilincinde olmayan) imanlılar, bulundukları yerdeki Ortodoks kiliselerini araştırabilir; her cemaatin kendi disiplini olduğunu ve bir rahibin komünyon vermeyi her zaman kabul etmeyebileceğini unutmayın.",
  "orthodoxNoteEn": "In some parts of Turkey there may be no Catholic church nearby, while an Orthodox one is. Canon law (1983 Code of Canon Law, Canon 844 §2) provides that when it is physically or morally impossible for a Catholic to reach a priest of their own Church, and a genuine need or spiritual advantage exists, and there is no danger of error or religious indifferentism, it is lawful to receive Holy Communion, Confession and the Anointing of the Sick from a Church (such as the Orthodox Church) whose sacraments the Catholic Church recognizes as valid. This is not an everyday practice but a permission for exceptional situations, and it does not extend to communities whose sacraments are not recognized as valid. The faithful who are properly disposed to receive Holy Communion (meaning not conscious of unconfessed mortal sin) may look for a local Orthodox church where they are; please keep in mind that each community has its own discipline, and a priest may not always be able to offer Communion.",
  "rites": [
  ...
  "cities": [
    {
      ...
      "churches": [
        ...
        { "id": "aziz-stefanos-yesilkoy",
          ...
          "rite": "latin", "district": "Yeşilköy, Bakırköy",
          "address": "Yeşilköy Mah., Cumhuriyet Sokak No. 8, Bakırköy, İstanbul",
          "website": "https://latinkatolikkilisesiistanbul.com/en/times-of-the-month/",
          "hours": "Pazartesi–Cumartesi: 18:00 (Türkçe). Cumartesi ayrıca: 18:00 (Pazar arifesi ayini). Pazar: 10:30 (Türkçe). Saatler değişebilir; kiliseyle teyit edin.",
          "hoursEn": "Monday–Saturday: 6:00pm (Turkish). Saturday is also the Sunday-vigil Mass. Sunday: 10:30am (Turkish). Times change; confirm with the parish." },
    ...
    },
    {
      ...
      "churches": [
        { "id": "aziz-meryem-bursa",
          ...
          "address": "Hocaalizade, Fransız Kilisesi Necatibey Meslek Lisesi Karşısı, Rakım Sokak No. 3, 16230 Osmangazi, Bursa",
          "website": "https://latinkatolikkilisesiistanbul.com/en/times-of-the-month/",
          "hours": "Ayin saatleri için kiliseyle görüşün.",
          "hoursEn": "Contact the parish for current Mass times.",
          "inactive": true,
          "inactiveNote": "Bu kilise şu anda kapalıdır. Katolik, Ortodoks ve Protestan cemaatlerinin birlikte kullandığı bina, Bursa Vakıflar Bölge Müdürlüğü tarafından depreme dayanıksız bulunduğu gerekçesiyle kapatıldı; son ayin 16 Şubat 2025’te yapıldı. Cemaate alternatif bir mekân tahsis edilmedi ve yeniden ne zaman açılacağı bilinmiyor. Bursa Protestan Cemaati önderi, kapatma gerekçesinin bağımsız bir jeoloji raporuyla örtüşmediğini öne sürmüştür. Ziyaretten önce güncel durumu araştırmanızı öneririz.",
          "inactiveNoteEn": "This parish is currently closed. The building, shared by the Catholic, Orthodox and Protestant communities, was shut down by Bursa’s Directorate of Foundations, which found it unsafe in an earthquake; the last Mass was held on 16 February 2025. No alternative location has been assigned to the community and it is unclear when it will reopen. The Bursa Protestant community’s leader has said the stated reasons for the closure don’t match an independent geology report. We’d suggest checking the current status before visiting." }
      ]
    },
    {
      "id": "mersin",
