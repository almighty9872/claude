/* =====================================================================
 * EN: The Parables of Jesus, grouped into six thematic categories.
 *     Original Turkish retellings and plain-language explanations
 *     written for this site, not a translation of any single Bible
 *     edition's wording (paraphrase, not verbatim Scripture text).
 *     References follow the Synoptic Gospels. "\n" = paragraph break.
 *     Each item's "en" field is the verbatim Scripture text (Douay-
 *     Rheims, public domain) for the parable proper, no paraphrase.
 * TR: Isa'nin meselleri, alti kategoride. Duzenledikten sonra
