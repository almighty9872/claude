...
function mark(app) { try { history.pushState(stateOf(app), ''); depth++; } catch (e) {  } }
...
else { try { history.replaceState(stateOf(openApp), ''); } catch (e) {  } }
});
var L = LANG === 'en'
...
treeChrome(pg);
try { history.replaceState(stateOf(openApp), ''); } catch (e) {  }
t.busy = false;
return true;
