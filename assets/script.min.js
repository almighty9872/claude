...
var DATA_VER = {"data/anadolu-harita-sekli.js":"dd83f98ad5","data/anadolu-haritasi.js":"15343a145d","data/azizler-adlar.js":"52176ec0a5","data/azizler-ozet-1.js":"133d061e7b","data/azizler-ozet-10.js":"3ba76f4935","data/azizler-ozet-11.js":"68f9a08be3","data/azizler-ozet-12.js":"004e410764","data/azizler-ozet-2.js":"4a0fd86f52","data/azizler-ozet-3.js":"bb11d07515","data/azizler-ozet-4.js":"68b4798f49","data/azizler-ozet-5.js":"e6b120e09d","data/azizler-ozet-6.js":"a1a5a5c40a","data/azizler-ozet-7.js":"533a10be03","data/azizler-ozet-8.js":"b22acf3b14","data/azizler-ozet-9.js":"d1d56af3cb","data/azizler.js":"cd44bc76d1","data/buyuk-azizler.js":"7c96efd04d","data/compendium-1.js":"88c806b124","data/compendium-2.js":"d5d8d2da58","data/compendium-3.js":"9c355bb584","data/compendium-4.js":"ea7011a774","data/extras.js":"d566b7a419","data/gunah-cikarma.js":"1b2efaca9e","data/katolik-sureci.js":"636c54d96c","data/kiliseler.js":"d6e93ae524","data/kutsal-ayin.js":"f7f7ed55d9","data/meseller.js":"a51bbbfca3","data/mucizeler.js":"ccf431d4d7","data/neden-katoligiz.js":"4f0b799118","data/sss.js":"35027e1292","data/tespih.js":"535aa7a03d","data/topraklarimizda-hristiyanlik.js":"b0ff240592"};
...
try { localStorage.setItem(FONTSIZE_KEY, String(next)); } catch (e) {  }
syncFontsize();
});
});
}
...
try { localStorage.setItem(SAVE_KEY, JSON.stringify({ day: dayStamp(), set: select.value, idx: idx, done: done })); } catch (e) {  }
}
...
function mark(app) { try { history.pushState({ homeApp: app.id.slice(4) }, ''); marked = true; } catch (e) {  } }
...
if (location.hash && /^#app-(ogren|dua|kesfet)$/.test(location.hash)) { try { history.replaceState(history.state, '', location.pathname); } catch (e) {  } }
}
...
else if (st && st.homeApp) { try { history.replaceState(null, ''); } catch (e) {  } }
}
var AV_TX = {
...
var ref = null;
try { if (document.referrer && new URL(document.referrer).origin === location.origin) ref = new URL(document.referrer); } catch (e) {  }
try { sessionStorage.setItem('avt:' + location.pathname, pageT); } catch (e) {  }
if (ref && ref.pathname !== location.pathname) {
var refT = null; try { refT = sessionStorage.getItem('avt:' + ref.pathname); } catch (e) {  }
...
try { pref = localStorage.getItem(ORIG_KEY) || 'tr'; } catch (e) {  }
...
try { localStorage.setItem(ORIG_KEY, pref); } catch (err) {  }
var target = cur || main;
...
try { history.replaceState({ av: 1, pushed: same && !!(history.state && history.state.pushed) }, '', '#soru-' + n); } catch (e) {  }
scrolls[keyOf(cur)] = 0;
...
place(sn);
try { history.replaceState({ av: 1, pushed: false }, '', location.href); } catch (e) {  }
...
try { if (window.top !== window.self) window.top.location = window.self.location.href; } catch (e) {  window.top.location = window.self.location.href; }
}
function initEmail() {
...
try { localStorage.setItem(FONTSIZE_KEY, on ? '2' : '0'); } catch (e) {  }
syncFontsize();
}
